      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mt-8">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-green-500 hover:bg-green-600 px-6 rounded-xl text-white font-semibold transition"
              >
                <Plus size={20} />
                Add
              </button>
          ...
          {filteredTodos.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-lg p-16 mt-8 text-center">
            ...
            <div className="space-y-6 mt-8">
              ...
              {filteredTodos.map((todo, index) => (
                ...
                <div
                  key={todo._id}
                  className={`bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4 ${todo.completed
                    ? "border-green-500"
                    : "border-blue-700"
                    }`}
                >
                    ...
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        {editingId === todo._id ? (
                          ...
                          <>
                            <h2
                              className={`text-2xl font-semibold ${todo.completed
